...
void NavierStokesSolver<T>::solvePressurePoisson(double dt) {
    ...
    // Use the public pressureField() accessor instead of directly accessing private p_
    std::vector<std::vector<std::vector<T>>> p_new = grid_.pressureField();
